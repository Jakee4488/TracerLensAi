...
SYNTHETIC_DATA = [
    ...
    {"user_id": "user_456", "prompt": "I want to cancel my account, your service is terrible. I will sue."},
...
async def run_evaluation():
    ...
    try:
        ...
        for row in SYNTHETIC_DATA:
            ...
            print(f"Result: Escalated={res['escalated']}, Latency={res['metrics']['latency_ms']:.2f}ms\n")
            
        print("Evaluation Summary:")
        print(json.dumps(results, indent=2))
        
    except Exception as e:
        print(f"Evaluation failed (likely missing credentials for mock run): {e}")

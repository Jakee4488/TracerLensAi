...
async def test_fallback_uses_second_model():
    ...
    fail_response = AgentResponse(content="", provider="vertex-ai", model_name="gemini-3.5-flash", error="Rate limit")
    success_response = AgentResponse(content="Success on try 2!", provider="vertex-ai", model_name="gemini-3-pro-image", error=None)
